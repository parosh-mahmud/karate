// pages/admin/registrations/running.js
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-2xl max-w-2xl w-full">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
          ...
          <DetailItem label="Age" value={registration.age} />
          ...
          <DetailItem label="NID / Birth Cert." value={registration.nid} />
          <DetailItem label="T-Shirt Size" value={registration.tshirtSize} />
          <DetailItem label="Occupation" value={registration.occupation} />
          <DetailItem label="Institution" value={registration.institution} />
          <DetailItem label="Hall" value={registration.hall} />
          <DetailItem label="Session" value={registration.session} />
          <div className="md:col-span-2 lg:col-span-3">
            <DetailItem label="Address" value={registration.address} />
          </div>
          <hr className="md:col-span-2 lg:col-span-3 my-2 dark:border-slate-700" />
          <DetailItem
          ...
          <DetailItem
            ...
            value={registration.transactionNumber}
          />
...
export default function RunningRegistrationsPage() {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute(
      "download",
      `running_registrations_${new Date().toISOString().split("T")[0]}.csv`
    );
