const blogs = [
  {
    id: 1,
    title: "The Art and Discipline of Karate: More Than Just Self-Defense",
    description:
    ...
    Another significant aspect of karate is kata, a series of choreographed movements that simulate fighting scenarios. Each kata tells a story, preserving the techniques, strategies, and spirit of karate’s origins. Practicing kata helps students internalize techniques and strategies that can be applied instinctively if needed. Whether a practitioner is interested in self-defense or simply looking to better understand themselves, karate offers something for everyone, making it truly a lifelong journey.`,
  ...
  },
  {
    id: 2,
    title:
      "The Benefits of Karate for Kids: Building Confidence and Discipline",
    description:
    ...
    Karate also instills discipline and respect. Classes begin and end with a bow, symbolizing respect for the instructor and fellow students. Through structured routines, children learn to follow directions, wait their turn, and focus on the task at hand. These qualities often translate into improved behavior and concentration in school and other areas of life.

    Additionally, karate promotes physical fitness, improving children’s strength, coordination, and balance. This can be especially beneficial as children grow, helping them develop strong, healthy bodies and lifelong fitness habits. Beyond the physical benefits, karate teaches children valuable life lessons about resilience, humility, and respect for themselves and others. For parents looking for an enriching activity for their kids, karate offers an environment that supports their growth into well-rounded individuals.`,
    author: "Coach Yamada",
    timeAgo: "1 week ago",
  },
];
